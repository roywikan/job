...
<html lang="en-US">
	...
	<title>Log In &lsaquo; Job Web &#8212; WordPress</title>
...
<link rel="stylesheet" id="login-css" href="/wp-admin/css/login.min.css" type="text/css" media="all">
	...
	<script type="text/javascript">document.body.className = document.body.className.replace('no-js','js');</script>
		<div id="login">
		<h1><a href="/">Job Web</a></h1>
	
		<form name="loginform" id="loginform" action="https://job.web.id.id/wp-login.php" method="post">
			<p>
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Log In">
									<input type="hidden" name="redirect_to" value="https://job.web.id.id/wp-admin/">
...
var userProfileL10n = {"user_id":"0","nonce":"d63d981b8f"};
/*  */</script>
